...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('liked_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='like_to', to='app.autouser')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='liked_from', to='app.autouser')),
            ],
        ),
        migrations.CreateModel(
            name='License',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('follow_from', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='follow_to', to='app.autouser')),
                ('follow_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='follow_from', to='app.autouser')),
            ],
        ),
        migrations.CreateModel(
            name='Club',
        ...
        migrations.AddField(
            model_name='autouser',
            name='follows',
            field=models.ManyToManyField(blank=True, related_name='followed', through='app.Follow', to='app.AutoUser'),
        ),
        migrations.AddField(
            model_name='autouser',
            name='like_users',
            field=models.ManyToManyField(blank=True, through='app.Like', to='app.AutoUser'),
        ),
        migrations.AddField(
            model_name='autouser',
            name='user',
